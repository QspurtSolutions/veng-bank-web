...
<div class="mb-3">
    ...
    <div class="col-md-4">
        <label for="inputState" class="form-label">Created By</label>
        <select id="created" name="created"  class="form-select">
            <option selected>Select Creaters</option>
            <option value="Admin">Admin</option>
            <option value="Blog User">Blog User</option>
        </select>
    </div>
