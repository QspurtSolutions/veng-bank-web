    ...
    <div class="card-body">
        <form class="row g-3" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                ...
                <input type="text" name="news" id="news" class="form-control @error('news') is-invalid @enderror" value="{{ old('news', $news->news) }}" placeholder="Enter news">
                @error('news')
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-light px-5">{{ $news->id ? 'Update' : 'Submit' }}</button>
            </div>
        </form>
    </div>
</div>
