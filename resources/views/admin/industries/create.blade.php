...
<form class="row g-3" method="POST" enctype="multipart/form-data">
    ...
    <label for="heading">Heading <span class="text-danger"> *</span></label>
        <input type="text" name="heading" id="heading" class="form-control @error('heading') is-invalid @enderror" value="{{ old('heading', $industries->heading ?? '') }}" placeholder="Enter Heading">
        @error('heading')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <label for="description">Sub Description<span class="text-danger"> *</span></label>
        <textarea type="text" name="subdis" id="subdis" class="form-control @error('subdis') is-invalid @enderror" value="{{ old('subdis', $industries->subdis ?? '') }}"></textarea>
        @error('subdis')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <textarea type="text" name="description" id="description" class="ckeditor form-control @error('description') is-invalid @enderror" value=" {{ old('description', $industries->description ?? '') }}"></textarea>
        @error('description')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-12">
    <label for="formFile">Industries Icon<span class="text-danger">*<span></label>
    ...
    <div class="col-12">
        <button type="submit" class="btn btn-light px-5">{{ isset($industries) ? 'Update' : 'Submit' }}</button>
    </div>
</form>
</div>
</div>
