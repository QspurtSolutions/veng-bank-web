    ...
    <div class="card-body">
        <form class="row g-3" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                ...
                <input type="text" name="heading" id="heading" class="form-control @error('heading') is-invalid @enderror" value="{{ old('heading', $form->heading) }}" placeholder="Enter heading">
                @error('heading')
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-light px-5">{{ $form->id ? 'Update' : 'Submit' }}</button>
            </div>
        </form>
    </div>
</div>
